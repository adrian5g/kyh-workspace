...
function wear_ids_menu()
	ids = {"1623134894","98049195","602414487","1163388406","136979639","1659869159","1868976371","578453393"}

	menu = gg.choice({"Custom", "Adamant Helmet (Hat)","Chest (Hat)","Dr Plague (Mask)","Anime Glasses (Mask)","Smart Bullet Bazooka (Mask)","Hepi (Mask)","Cloak of Night (Cape)","Manuvering Modules (Cape)"})
